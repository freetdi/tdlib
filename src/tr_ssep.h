...
// This is based on MIT licensed java code from the PACE submission
// Copyright (c) 2017, Hisao Tamaki

//static int MAX_MISSINGS = 100;
//static int DEFAULT_MAX_STEPS = 1000000;
//static bool CONFIRM_MINOR = true;
