...
# hopefully obsolete..
    int gc_preprocessing(vector[unsigned int] &V_G, vector[unsigned int] &E_G, vector[vector[int]] &bags, int lb, unsigned graphtype)
...
############ EXACT ALGORITHMS ################################
    ...
    int gc_exact_decomposition_ta(vector[unsigned int] &V_G, vector[unsigned int] &E_G,
                                  vector[vector[int]] &V_T, vector[unsigned int] &E_T, int lb, unsigned graphtype)
