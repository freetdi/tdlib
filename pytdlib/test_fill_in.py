...
class TestTdLib(unittest.TestCase):
    ...
    def test_fillIn_decomp_4(self):
        V, E, w = tdlib.fillIn_decomp(V_Petersen_double, E_Petersen_double)
    ...
    def test_fillIn_decomp_5(self):
        V, E, w = tdlib.fillIn_decomp(V_Wagner, E_Wagner)
    ...
    def test_fillIn_decomp_7(self):
        V, E, w = tdlib.fillIn_decomp(V_Grid_5_5, E_Grid_5_5)
    ...
    def test_fillIn_ordering_4(self):
        O = tdlib.fillIn_ordering(V_Petersen_double, E_Petersen_double)
        self.assertEqual(len(O), len(V_Petersen_double))

    def test_fillIn_ordering_5(self):
        O = tdlib.fillIn_ordering(V_Wagner, E_Wagner)
    ...
    def test_fillIn_ordering_7(self):
        O = tdlib.fillIn_ordering(V_Grid_5_5, E_Grid_5_5)
