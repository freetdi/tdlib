...
class TestTdLib_app(unittest.TestCase):
    ...
    def test_min_vertex_cover_with_treedecomposition2_0b(self):
        V, E = cornercases[1]
        G = Graph(V, E)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
    ...
    def test_min_vertex_cover_with_treedecomposition2_0c(self):
        V, E = cornercases[2]
        G = Graph(V, E)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
    ...
    def test_min_vertex_cover_with_treedecomposition2_0d(self):
        V, E = cornercases[3]
        G = Graph(V, E)
        T,  w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
    ...
    def test_min_vertex_cover_with_treedecomposition2_1(self):
        G = Graph(V_P6, E_P6)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 3)
    ...
    def test_min_vertex_cover_with_treedecomposition2_3(self):
        G = Graph(V_Petersen, E_Petersen)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 6)

    def test_min_vertex_cover_with_treedecomposition2_4(self):
        G = Graph(V_Petersen_double, E_Petersen_double)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 12)

    def test_min_vertex_cover_with_treedecomposition2_5(self):
        G = Graph(V_Wagner, E_Wagner)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 5)

    def test_min_vertex_cover_with_treedecomposition2_6(self):
        G = Graph(V_Pappus, E_Pappus)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 9)

    def test_min_vertex_cover_with_treedecomposition2_7(self):
        G = Graph(V_Grid_5_5, E_Grid_5_5)
        T, w = tdlib.PP_MD(G)
        S = tdlib.min_vertex_cover_with_treedecomposition2(G, T)
        self.assertEqual(len(S), 12)

    def test_min_vertex_cover_with_treedecomposition2_8(self):
        for n in range(0, 13):
            for i in range(0, 10):
                V, E = randomGNP(n, 0.2)
                G = Graph(V, E)
